...
export default function PaymentContent() {
  ...
  const header = <header className="bakery-header"><div className="bakery-container header-inner"><Link href="/" className="wordmark">japhee<span>CAKES & BAKING SCHOOL</span></Link><Link href="/" className="text-link"><ArrowLeft size={15} /> Continue shopping</Link></div></header>;
