...
export default async function AdminDashboardPage() {
  ...
  return <main className="bakery-container bakery-section"><div className="section-heading"><div><p className="eyebrow">JAPHEE ADMINISTRATION</p><h1 className="font-serif text-4xl">The bakery, at a glance.</h1></div><Link href="/" className="bakery-button secondary">View storefront</Link></div>
