...
export default function SchoolTab({ handleEnrollCourse, isSubmitting }: { handleEnrollCourse: (id: string) => void; isSubmitting: boolean }) {
  ...
  return <section className="bakery-container bakery-section">
    <div className="catalog-heading"><p className="eyebrow">JAPHEE SCHOOL OF CAKES</p><h1>A skill worth making time for.</h1><p>Explore baking and decorating courses. Find your level and take the next step.</p></div>
